...
import { OwaspRiskCalculator } from "@/components/owasp/OwaspRiskCalculator";
import { 
  BaseMetricGroup, 
  CVSSScore, 
  CVSSState, 
...
import { AlertTriangle, Calculator, FileCode, RefreshCw, Activity } from 'lucide-react';
...
const CVSS: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<string>("cvss");
  const [cvssActiveTab, setCvssActiveTab] = useState<string>("base");
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Calculate vulnerability scores based on standardized methodologies to determine the severity of security vulnerabilities.
        </p>
      </div>

      <Tabs defaultValue="cvss" value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="w-full mb-6 grid grid-cols-2">
          <TabsTrigger value="cvss" className="flex items-center gap-2">
        ...
        <TabsContent value="cvss" className="mt-0">
          <div className="grid gap-6 lg:grid-cols-5">
            <div className="lg:col-span-3 order-2 lg:order-1">
              <Card className="shadow-md h-full">
                ...
                <CardContent>
                  <Tabs value={cvssActiveTab} onValueChange={setCvssActiveTab} className="w-full">
