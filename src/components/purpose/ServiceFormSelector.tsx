    ...
    case 'web':
      return (
        <Card className="mt-4">
          ...
          <CardContent>
            <WebServiceForm onChange={(config) => onChange(config)} />
          </CardContent>
        </Card>
      );
    case 'cloud':
      return (
        <Card className="mt-4">
          ...
          <CardContent>
            <CloudServiceForm onChange={(config) => onChange(config)} />
          </CardContent>
        </Card>
      );
    case 'network':
      return (
        <Card className="mt-4">
          ...
          <CardContent>
            <NetworkServiceForm onChange={(config) => onChange(config)} />
          </CardContent>
        </Card>
      );
    case 'mobile':
      return (
        <Card className="mt-4">
          ...
          <CardContent>
            <MobileServiceForm onChange={(config) => onChange(config)} />
          </CardContent>
        </Card>
      );
    default:
